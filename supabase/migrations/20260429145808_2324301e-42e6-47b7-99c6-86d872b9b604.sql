...
-- Fix: pizza sem variation_id estava passando (preço base = 0). Exigir tamanho.
-- Substituímos somente o trecho ELSIF/ELSE relevante recriando a função com a
-- mesma lógica + validação extra.
...
BEGIN
    ...
    LOOP
        ...
        -- Pizza SEMPRE exige tamanho (variation_id) e variável também.
