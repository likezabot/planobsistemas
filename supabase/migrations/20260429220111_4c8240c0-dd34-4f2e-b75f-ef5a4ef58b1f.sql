-- Update open_table_order to set order_type
...
BEGIN
    ...
    INSERT INTO public.orders (
        restaurant_id, tenant_id, service_mode, table_id, opened_by, status, payment_status, subtotal_cents, total_cents, customer_name, customer_phone, order_type
    ) VALUES (
        _restaurant_id, v_tenant_id, 'table', _table_id, auth.uid(), 'new', 'open', 0, 0, v_table_name, '00000000', 'pickup'
...
-- Update create_counter_order to set order_type
...
BEGIN
    ...
    INSERT INTO public.orders (
        restaurant_id, tenant_id, service_mode, opened_by, status, payment_status, subtotal_cents, total_cents, customer_name, customer_phone, order_type
    ) VALUES (
        _restaurant_id, v_tenant_id, 'counter', auth.uid(), 'new', 'open', 0, 0, 'Balcão', '00000000', 'pickup'
    ) RETURNING id INTO v_order_id;
